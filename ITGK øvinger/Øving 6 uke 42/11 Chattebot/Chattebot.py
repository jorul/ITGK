...
# Output:       Ingen
def print_sentence(tekst1, tekst2, tekst3):
    print(f'{tekst1} {tekst2}{tekst3}')
...
def intro_text():
    for i in range (20):
        print('\n')
    print("Hei, jeg heter JorunnBot og vil gjerne snakke med deg.")
...
def main():
  ...
  while svar != "hade":
    ...
    # ved hjelp av funksjonen pick_sentence
    oppfolge = pick_sentence(follow_ups)
 
    # Skriv oppfølgningsspørsmålet sammen med svaret fra brukeren
    # og et spørsmålstegn ved hjelp av funksjonen print_sentence
    print_sentence(oppfolge, svar, '?')
