...
def main():
    ...
    listami = s.split(',')
    listami[1] = int(listami[1])
    if listami[0] == 'm':
        cupcake(listami[1],listami[2],listami[3], listami[4])
    elif listami[0]=='b':
        flower(listami[1],listami[2],listami[3], listami[4])
    elif listami[0] == 's':
        chocolate(listami[1],listami[2],listami[3], listami[4])

 #Skriv inn kode slik at det bruker har skrevet inn tegnes med de oppgitte spesifikasjonene.
